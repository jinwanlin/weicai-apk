...
//		}
	...
	private void setTabSelection(int index) {
		...
		case 0:
			...
			productsImage.setImageResource(R.drawable.products_selected);
		...
		case 1:
			...
			ordersImage.setImageResource(R.drawable.orders_selected);
		...
		case 2:
			...
			paymentsImage.setImageResource(R.drawable.payments_selected);
	...
	private void clearSelection() {
		productsImage.setImageResource(R.drawable.products_unselected);
		productsText.setTextColor(Color.parseColor("#82858b"));
		ordersImage.setImageResource(R.drawable.orders_unselected);
		ordersText.setTextColor(Color.parseColor("#82858b"));
		paymentsImage.setImageResource(R.drawable.payments_unselected);
